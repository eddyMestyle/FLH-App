...
class PredictionServiceClient {
    ...
    constructor(opts) {
        ...
        const batchPredictResponse = protoFilesRoot.lookup('.google.cloud.automl.v1.BatchPredictResult');
        const batchPredictMetadata = protoFilesRoot.lookup('.google.cloud.automl.v1.OperationMetadata');
        this.descriptors.longrunning = {
            batchPredict: new this._gaxModule.LongrunningDescriptor(this.operationsClient, batchPredictResponse.decode.bind(batchPredictResponse), batchPredictMetadata.decode.bind(batchPredictMetadata)),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.automl.v1.PredictionService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.predictionServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.automl.v1.PredictionService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.automl.v1.PredictionService, this._opts, this._providedCustomServicePath);
    ...
    batchPredict(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkBatchPredictProgress(name) {
