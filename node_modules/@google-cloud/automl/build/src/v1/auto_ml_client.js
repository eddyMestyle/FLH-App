...
class AutoMlClient {
    ...
    constructor(opts) {
        ...
        const createDatasetResponse = protoFilesRoot.lookup('.google.cloud.automl.v1.Dataset');
        const createDatasetMetadata = protoFilesRoot.lookup('.google.cloud.automl.v1.OperationMetadata');
        const deleteDatasetResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteDatasetMetadata = protoFilesRoot.lookup('.google.cloud.automl.v1.OperationMetadata');
        const importDataResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const importDataMetadata = protoFilesRoot.lookup('.google.cloud.automl.v1.OperationMetadata');
        const exportDataResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const exportDataMetadata = protoFilesRoot.lookup('.google.cloud.automl.v1.OperationMetadata');
        const createModelResponse = protoFilesRoot.lookup('.google.cloud.automl.v1.Model');
        const createModelMetadata = protoFilesRoot.lookup('.google.cloud.automl.v1.OperationMetadata');
        const deleteModelResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteModelMetadata = protoFilesRoot.lookup('.google.cloud.automl.v1.OperationMetadata');
        const deployModelResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deployModelMetadata = protoFilesRoot.lookup('.google.cloud.automl.v1.OperationMetadata');
        const undeployModelResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const undeployModelMetadata = protoFilesRoot.lookup('.google.cloud.automl.v1.OperationMetadata');
        const exportModelResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const exportModelMetadata = protoFilesRoot.lookup('.google.cloud.automl.v1.OperationMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.automl.v1.AutoMl', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.autoMlStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.automl.v1.AutoMl')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.automl.v1.AutoMl, this._opts, this._providedCustomServicePath);
